                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Indoor Team</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Indoor Team</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                 ...
                                 <option class="bloodgrouplist" value="<?php echo $data->role_id; ?>"> <?php echo  $data->role_name; ?>
                                        ...
                                        <div class="col-4">
                                           <div class="form-group">
                                                <div class="form-group">
                                                    <label>Modules</label>
                                                    <select class="select2-multiple" data-toggle="select2" style="width: 100%;" multiple="multiple" name="module_access[]" id="module_access">
                                                    
                                                      <option class="bloodgrouplist" value="Dashboard">Dashboard</option>
                                                       <option class="bloodgrouplist" value="Operation">Operation</option>
                                                        <option class="bloodgrouplist" value="Team">Team</option>
                                                         <option class="bloodgrouplist" value="Store">Store</option>
                                                          <option class="bloodgrouplist" value="Reports">Reports</option>
                                                           <option class="bloodgrouplist" value="Scoreboard">Scoreboard</option>
                                                            <option class="bloodgrouplist" value="Settings">Settings</option>

                                                     </select>
                                                     <span id="modulespan" style="color: red;"></span>
                                            </div>
                                        </div>   
                                    ...
                                    <div class="row">          
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="hidden" name="team_type" value="<?php //ehco $team_type ?>">
                                        </div>
                                    </div>
...
<script>
    ...
    function btnsubmit() {
       ...
       // console.log($('#teamlimit').val());
                ...
                if($('#module_access').val() == ''){

                    $('#modulespan').text("Please Select Module!");
                    $('#module_access').css("border","1px solid red");
                 ...
                 if($('#module_access').val() != ''){
                    ...
                    $('#modulespan').text("");
                    $('#module_access').css("border","1px solid green");
                ...
                if(check == 1) {
                    ...
                    if(temp == "1"){
                        var txt="Indoor Team Added!"
                    }else{
                        var txt="Indoor Team Updated!"
                    }
                            ...
                            confirmButtonClass:"btn btn-confirm mt-2"}).then((result)=>{
                                if(result.value){
                                    $('#add_indoor').attr('action',' <?php echo base_url() ?>admin/Indoorteam/add_indoor');
                                   $('#add_indoor').submit();
                                }
                            })
        ...
        console.log("Clicked ID:"+id);
              ...
              Swal.fire({
                         ...
                         if (result.value) {
                            ...
                            confirmButtonClass:"btn btn-confirm mt-2"}).then((result)=>{
                                if(result.value){
                                    window.location.href="<?php echo base_url() ?>admin/Indoorteam/delete/"+id;
