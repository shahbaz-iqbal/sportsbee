...
<div class="wrapper">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Active Teams</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Active Teams</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <h4 class="header-title">Active Teams</h4>
                    <p class="sub-header text-warning">
                        <?php $a = count($users); ?>
                        Total Active Teams: <?php echo $a; ?>                            
                    </p>
                                ...
                                <?php foreach ($users as $user) { ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post" action="<?php echo base_url(); ?>admin/update_active_team/<?php echo $user->id; ?>">
