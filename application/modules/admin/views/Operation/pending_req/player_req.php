...
<div class="wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Player Request</h4>
                </div>
            </div>   
        </div>
        <!-- end page title --> 
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <h4 class="header-title">Active Players</h4>
                    <p class="sub-header text-warning">
                        <?php $a = count($users); ?>
                        Total Pending Request: <?php echo $a; ?>                   
                    </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br><b class='text-primary'>CNIC: </b><?php echo $user->cnic; ?>,<br><b class='text-primary'>DOB: </b><?php echo $user->dob; ?>,<br><b class='text-primary'>FATHERNAME: </b><?php echo $user->fathername; ?><br><b class='text-primary'> Gender: </b> <?php echo $user->gender; ?> <br><b class='text-primary'>Blood Group: </b><?php echo $user->bloodgroup; ?>,<br><b class='text-primary'>Bio: </b>"<?php echo $user->bio; ?>"<br><b class='text-primary'> <i class='mdi  mdi-phone'></i> </b> <a href='<?php echo $user->phone1; ?>'><?php echo $user->phone1; ?></a>, <b class='text-primary'><i class='mdi  mdi-phone'></i></b> <a href='<?php echo $user->phone2; ?>'><?php echo $user->phone2; ?></a><br><b class='text-primary'> Social Accounts: <?php echo $user->id; ?></b> 
