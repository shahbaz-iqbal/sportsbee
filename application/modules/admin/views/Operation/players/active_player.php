            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <p class="sub-header text-warning">
                        <?php $a = count($users); ?>
                        Total Active Players: <?php echo $a; ?>                   
                    </p>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br><b class='text-primary'>CNIC: </b>,<br><b class='text-primary'>DOB: </b>,<br><b class='text-primary'>FATHERNAME: </b><br><b class='text-primary'> Gender: </b> <?php echo $user->gender; ?> <br><b class='text-primary'>Blood Group: </b>,<br><b class='text-primary'>Bio: </b>""<br><b class='text-primary'> <i class='mdi  mdi-phone'></i> </b> <a href=''></a>, <b class='text-primary'><i class='mdi  mdi-phone'></i></b> <a href=''></a><br><b class='text-primary'> Social Accounts: </b> 
                                            ...
                                            <td>
                                                <form method="post" action="<?php echo base_url(); ?>admin/update_active_player/<?php echo $user->id; ?>">
