...
//     }
    ...
    public function tournment_req_detail() {
         
            $result = $this->db->select('tournament_team.*,tournament.title as tournmentName,team.name as teamName')
                            ->from('tournament_team')
                            ->join('tournament', 'tournament.tournid = tournament_team.tournid', 'left')
                            ->join('team', 'team.team_id = tournament_team.team_id', 'left')
                            ->get()->result();
        return $result;
  
//       $query = $this->db->get('tournament_team');
//        $result = $query->result();
//       return $result;
    }

    public function tournment_req_accept($id,$data) {
        $this->db->where('tournament_team_id', $id);
        $result = $this->db->update('tournament_team', $data);
        return $result;
    }
    public function tournment_req_reject($id,$data) {
        $this->db->where('tournament_team_id', $id);
        $result = $this->db->update('tournament_team', $data);
        return $result;
    }
