...
//     }
    ...
    public function tournment_req() {
        $res = $this->Tournaments->tournment_req_detail();
        $data = [
            'users' => $res
        ];
        $this->load->view('player_tournment_req', $data);
    }

    public function tournment_req_accept() {
        $id = $this->uri->segment(4);
        ...
        $data = [
            'status' => $status,
            'request_aprove_date' => $date
        ];
        $res = $this->Tournaments->tournment_req_accept($id, $data);
        redirect('admin/Tournament/tournment_req');
    }

    public function tournment_req_reject() {
        $id = $this->uri->segment(4);
         $this->load->helper('date');
        $datestring = '%Y / %m / %d ';    
        $date = mdate($datestring);
        ...
        $res = $this->Tournaments->tournment_req_reject($id, $data);
        redirect('admin/Tournament/tournment_req');
    }
