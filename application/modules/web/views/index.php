...
<div class="wrapper">
    <div class="row" style="background-repeat: no-repeat; background-size: cover; position: relative; width:103%; height:auto; overflow: hidden;">
        <img class="mySlides" src="<?php echo base_url('application/assets/images/dashboard1.png'); ?>" style="width:100%; height: auto;">
        <img class="mySlides" src="<?php echo base_url('application/assets/images/dashboard2.png'); ?>" style="width:100%; height: auto;">
...
<!--    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <video id="v" style="border:2px solid #B22E06; background-color: #FFAC1B;" controls preload='auto' width='540' height='330'>
                    <source id="webm" src="<?php echo base_url('application/assets/videos/video2.mp4'); ?>" 
                            type='video/webm;codecs="vp8, vorbis"' />
                    <source id="mp4" src="<?php echo base_url('application/assets/videos/video2.mp4'); ?>" 
            ...
            <div class="col-lg-6">
                <video id="v" style="border:2px solid #B22E06; background-color: #FFAC1B;" controls preload='auto' width='540' height='330'>
                    <source id="webm" src="<?php echo base_url('application/assets/videos/video1.mp4'); ?>" 
                            type='video/webm;codecs="vp8, vorbis"' />
                    <source id="mp4" src="<?php echo base_url('application/assets/videos/video1.mp4'); ?>" 
                            type='video/mp4;codecs="avc1.42E01E, mp4a.40.2"' />
                    <source src="video2.ogg" type="video/ogg">
                    <p>Your browser does not support this video.</p>
                </video>
    ...
    <!-- ============================================================== -->
    <div class="row pointtable_section" style="background-repeat: no-repeat; background-size: cover;  position: relative; width: 102%; height: auto; background-image: url('application/assets/images/tablepointsbackground.jpg');">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-xl-4">
                    ...
                    <div class="pointtable_grid_videos">
                        <div class="row pointtable_grid_videos_row js-video-button" data-channel="video" data-video-url="<?php echo base_url('application/assets/videos/video1.mp4'); ?>">
                            <div class="col-sm-4 col-md-4 col-xl-4">
                                <div class="pointtable_grid_videos_image_div">
                                    <img src="<?php echo base_url('application/assets/images/video1.jpg'); ?>" alt="">
                        ...
                        <div class="row  pointtable_grid_videos_row js-video-button" data-channel="video" data-video-url="<?php echo base_url('application/assets/videos/video2.mp4'); ?>">
                            <div class="col-sm-4 col-md-4 col-xl-4">
                                <div class="pointtable_grid_videos_image_div">
                                    <img src="<?php echo base_url('application/assets/images/video2.jpg'); ?>" alt="">
                                    <i class="mdi mdi-play pointtable_grid_videos_i"></i>
                                </div>
                            </div>
                            <div class="col-sm-8 col-md-8 col-xl-8">
                        ...
                        <div class="row  pointtable_grid_videos_row js-video-button" data-channel="video" data-video-url="<?php echo base_url('application/assets/videos/video1.mp4'); ?>">
                            <div class="col-sm-4 col-md-4 col-xl-4">
                                <div class="pointtable_grid_videos_image_div">
                                    <img src="<?php echo base_url('application/assets/images/video3.jpg'); ?>" alt="">
                                    <i class="mdi mdi-play pointtable_grid_videos_i"></i>
                                </div>
                            </div>
                            <div class="col-sm-8 col-md-8 col-xl-8">
