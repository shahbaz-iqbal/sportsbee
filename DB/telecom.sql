...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2019 at 03:43 PM
...
(5, 1, 1, 'Network Issue ', '50', '20', '10', '84', '2019-10-03 10:34:49', 1),
(6, 1, 1, 'Mic Issue', '30', '10', '5', '48', '2019-10-03 10:34:49', 1),
(7, 1, 1, 'Camera Issue', '40', '10', '5', '60', '2019-10-03 10:34:49', 1),
(8, 1, 1, 'Charging issue', '30', '10', '10', '48', '2019-10-03 10:34:49', 1);
...
(5, 'Nokia', '2019-10-04 07:29:03', 1),
(6, 'Moto', '2019-10-04 07:30:54', 1),
(7, 'Black Berry', '2019-10-07 11:05:31', 1);
...
(10, 5, '3310', '2019-10-04 07:43:01', 1),
(11, 5, 'N7', '2019-10-04 07:43:53', 1);
...
(1, 4, 7, 1, 1, 'Federer \r\na\r\na\r\ns\r\nS\r\nS\r\nS\r\nS\r\nS\r\nS\r\nS\r\nSDASDASD\r\nSDSADAS\r\nASDASD\r\nASDASD\r\nSDASD', '398', '20', '378', '100', '29', 1, '25-09-2019', '30-09-2019', '2019-10-01 10:34:47', 1),
...
(6, 10, 13, '2019-10-11', '12:00:00', '2019-10-11 19:00:00'),
(7, 12, 11, '1970-01-01', '00:00:00', '1970-01-01 08:00:00'),
(8, 12, 14, '2019-10-11', '12:00:00', '2019-10-11 19:00:00'),
(9, 12, 13, '1970-01-01', '10:00:00', '1970-01-01 18:00:00'),
(10, 12, 13, '2019-10-12', '02:00:00', '2019-10-12 09:00:00'),
(11, 12, 11, '2019-10-11', '17:00:00', '2019-10-12 00:00:00'),
(12, 12, 13, '2019-10-11', '19:00:00', '2019-10-12 02:00:00');
...
(1, 1, 1, 1, 'cuz', '123456789012345', '1234', '12121313', ''),
...
(6, 2, 1, '1', '0', '1', '0', '0', '1'),
(7, 2, 2, '0', '1', '1', '1', '1', '0'),
(23, 2, 1, '1', NULL, NULL, NULL, NULL, NULL),
(24, 2, 2, '1', NULL, NULL, NULL, NULL, NULL),
(25, 2, 3, '1', NULL, NULL, NULL, NULL, NULL),
(26, 3, 4, '1', NULL, NULL, NULL, NULL, NULL),
(27, 3, 5, '0', NULL, NULL, NULL, NULL, NULL);
...
(1, 'Admin', '03001234567', 'admin@gmail.com', '54000', '21232f297a57a5a743894a0e4a801fc3', 'Lahore', '', '', '', '2019-09-25 08:24:39', 1, '2019-09-25 20:20:44', 1),
(2, 'agent1', '03011234567', 'agent1@gmail.com', '54000', 'e10adc3949ba59abbe56e057f20f883e', 'Lahore', '', '', '', '2019-09-25 08:24:39', 2, '', 1),
(3, 'ali', '03211234567', 'ali@gmail.com', '12000', 'e10adc3949ba59abbe56e057f20f883e', 'lahore ', '', '', '', '2019-09-25 14:04:09', 2, '', 1),
...
(5, 'zain', '023423234234', 'zain@gmail.com', '4646464', 'e10adc3949ba59abbe56e057f20f883e', 'Station Road, Frimley, Camberley GU16 7HF, UK', '', '', '', '2019-09-25 14:14:42', 2, '2019-10-01 10:32:42', 1),
(6, 'a', 'a', 'a@gmail.com', 'a', '0cc175b9c0f1b6a831c399e269772661', 'Agadir, Morocco', '', '', '', '2019-10-01 08:11:05', 2, '', 1),
(7, 'Azher Ashiq', '03211234567', 'azharashiq178@gmail.com', '1234', '', 'Station Road, Frimley, Camberley GU16 7HF, UK', '', '', '', '2019-10-01 10:34:47', 5, '', 1),
(8, ' Ashiq', '1234', 'azharashiq178@gmail.com', '1234', '', 'Test', '', '', '', '2019-10-01 10:36:15', 5, '', 1),
(9, 'Azher Ashiq', '1234', 'azharashiq178@gmail.com', '1234', '', 'Test', '', '', '', '2019-10-01 10:39:48', 5, '', 1),
(10, 'aaa', '2333', 'aa@gmail.com', '234', '81dc9bdb52d04dc20036dbd8313ed055', 'Lahore, Pakistan', '', '', '', '2019-10-02 05:49:49', 4, '', 1),
(11, 'aaa', '2222', 'aaa@gmailc.om', '12000', 'e10adc3949ba59abbe56e057f20f883e', 'Lahore, Pakistan', '', 'aa', 'test.com', '2019-10-02 06:01:20', 3, '', 1),
(12, 'ahmad', '00944', 'hamza@gmail.com', '4646464', '81dc9bdb52d04dc20036dbd8313ed055', 'Lagos, Portugal', '', '', '', '2019-10-02 06:25:35', 4, '', 1),
(13, 'naveed shop owner', '03211234567', 'sn@gamail.com', 'GU16 7HF', '81dc9bdb52d04dc20036dbd8313ed055', 'Station Road, Frimley, Camberley GU16 7HF, UK', '290', 'new shope tst', 'shopnew@gmail.com', '2019-10-03 09:46:37', 3, '', 1),
(14, 'suleman ahmad', '0321123456', 'pap@gmail.com', 'GU16 7HF', '81dc9bdb52d04dc20036dbd8313ed055', 'Station Road, Frimley, Camberley GU16 7HF, UK', '33', 'paper books', 'paperbook.com', '2019-10-03 09:51:00', 3, '', 1),
(15, 'suleman', '04253636322', 'suleman@gmail.com', 'B7 4DW', 'e10adc3949ba59abbe56e057f20f883e', 'Windsor Street, Birmingham B7 4DW, UK', '302', '', '', '2019-10-03 14:00:04', 2, '', 1);
...
(15, 5, 'e12959318e704a10c3d0bc3df22833d1', '2019-10-02 00:14:19', '0000-00-00 00:00:00', '2019-10-01 12:14:19'),
(16, 5, '762986fd9bcd0c444268c5e9d7908595', '2019-10-02 00:18:20', '0000-00-00 00:00:00', '2019-10-01 12:18:20');
...
--
ALTER TABLE `tbl_manufecturer`
  MODIFY `manufecturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_order_assign`
  MODIFY `order_assign_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_order_assign_detail`
--
ALTER TABLE `tbl_order_assign_detail`
  MODIFY `order_assign_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tbl_order_checklist`
--
ALTER TABLE `tbl_order_checklist`
  MODIFY `order_checklist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_order_device_info`
--
ALTER TABLE `tbl_order_device_info`
  MODIFY `order_device_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_order_issues`
--
ALTER TABLE `tbl_order_issues`
  MODIFY `order_issue_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_order_primary_test`
--
ALTER TABLE `tbl_order_primary_test`
  MODIFY `order_primary_test_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_primary_test`
  MODIFY `primary_test_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_users_authentication`
  MODIFY `user_authentication_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
